    ...
    <div class="login mt-20 mb-28 border h-auto w-[400px] mx-auto shadow-md">
      <div class="p-4">
        ...
        <div class="flex flex-wrap justify-between items-center mt-4">
          <div class="flex w-[140px] justify-between items-center text-slate-400">
            <label for="showPassword">Show Password</label>
            <input type="checkbox" id="showPassword" v-model="showPassword" />
          </div>
          <NuxtLink
            class="text-blue-700 items-center cursor-pointer underline"
            to="/auth/register"
          >
        ...
        <div class="mt-3 flex cursor-pointer" @click="loginWithGoogle">
          <img
            class="w-[60px]"
          ...
          />
          <h3 class="ml-4 text-blue-400 mt-4">Login with Google</h3>
        </div>
        
        <button class="p-2 rounded text-white mx-auto bg-blue-400 mt-4 w-full" @click="loginWithEmail">
          Login
        </button>
      </div>
    </div>
