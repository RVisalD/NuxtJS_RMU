    ...
    <div class="login mt-20 mb-28 border h-auto w-[400px] mx-auto shadow-md">
      <div class="p-4">
        ...
        <div class="flex flex-wrap justify-between items-center mt-4">
          <div
            class="flex w-[140px] justify-between items-center text-slate-400"
          >
        ...
        <div class="mt-3 flex cursor-pointer" @click="login">
          <img
            class="w-[60px]"
        ...
        <button class="p-2 rounded text-white mx-auto bg-blue-400 mt-4 w-full">
          Login
        </button>
      </div>
    </div>
